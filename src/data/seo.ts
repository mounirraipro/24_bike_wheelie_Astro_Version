...
const routeFallbackSeo = (route: SiteRoute): SeoPage => ({
  ...
  description:
    route.path === "/"
      ...
      : `${route.title} for ${siteConfig.name}, a free online bike balance and stunt game site.`,
  schemaType: "WebPage",
});
...
const pageOverrides: Partial<Record<string, Partial<SeoPage>>> = {
  "/": {
    ...
    seoTitle: `${siteConfig.name} Online - Free Wheelie Bike Game`,
    description: siteConfig.description,
    priority: 1,
    changeFrequency: "weekly",
  },
  "/play": {
    seoTitle: `Play ${siteConfig.name} Online - Free Bike Balance Game`,
    description: `Play ${siteConfig.name} online free with the Playgama Wheelie Bike iframe, instant browser loading, and related bike stunt games nearby.`,
    priority: 0.9,
    changeFrequency: "weekly",
  },
  "/games": {
    seoTitle: `Bike and Stunt Games - Playgama Related Games | ${siteConfig.name}`,
    description: `Browse related Playgama bike games, motorbike stunt games, motocross games, and physics riding games selected for ${siteConfig.name}.`,
    priority: 0.82,
    changeFrequency: "weekly",
  },
  "/how-to-play": {
  ...
  return [
    {
      ...
      alternateName: ["Bike Wheelie Online", "Wheelie Bike", "Wheelie Bike Game"],
